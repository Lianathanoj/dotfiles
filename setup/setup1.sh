...
###################################################################################################
# Description:  This creates the Github directory, downloads homebrew, downloads git, sets up git
#               credentials, and clones my dotfiles.
# Instructions: Navigate to https://github.com/Lianathanoj/dotfiles/setup1.sh, download the file,
#               and run `bash setup1.sh`. You'll need to intermittently type in certain
#               information such as password, Github credentials, etc. We need to do this in this
#               manner because some steps in setup2.sh require brew and git to be installed.
###################################################################################################
